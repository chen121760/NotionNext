...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jiawei Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '牛马', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next2-azure.vercel.app/', // 网站地址
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi🎉,你好呀！',
